...
class Meteor:
    ...
    def compute_score(self, gts, res):
        ...
        self.meteor_p.stdin.write('{}\n'.format(eval_line).encode('utf-8')) ## .encode() added by AC (bytes(eval_line+'\n','utf-8'))
    ...
    def _stat(self, hypothesis_str, reference_list):
        ...
        self.meteor_p.stdin.write('{}\n'.format(score_line).encode('utf-8'))   ## .encode() added by AC
        self.meteor_p.stdin.flush()
    ...
    def _score(self, hypothesis_str, reference_list):
        ...
        # EVAL ||| stats 
        self.meteor_p.stdin.write('{}\n'.format(eval_line).encode('utf-8'))   ## .encode() added by AC
        self.meteor_p.stdin.flush()
